...
public class MatchedSwitch<K, T, U, R> 
    ...
    @Override
    public <X extends Exception> BasicSwitch<K, T, U, R> map(CheckedFunction<T, U, X> function) throws X {
        return this;
    }
    ...
    protected static class LastCase<T, U, R> implements Switch.Case<T, U, R> {
        ...
        @Override
        public <X extends Exception> R map(CheckedFunction<T, U, X> function) throws X {
            return result;
        }
    }
}
