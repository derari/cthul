...
public interface Notifier {
    ...
    <O, X extends Exception> void accept(Class<O> observer, C0<O, X> signal) throws X;
    ...
    <O, T, R, X extends Exception> R apply(Class<O> observer, Function<? super Observable, ? extends Collector<? super T, ?, ? extends R>> collector, F0<O, T, X> signal) throws X;
    
    <O, T, R, X extends Exception> R apply(Class<O> observer, Collector<? super T, ?, ? extends R> collector, F0<O, T, X> signal) throws X;
    ...
    default <O, T, R, A1, X extends Exception> R apply(Class<O> observer, Function<? super Observable, ? extends Collector<? super T, ?, ? extends R>> collector, F1<O, A1, T, X> signal, A1 arg1) throws X {
        return apply(observer, collector, o -> signal.apply(o, arg1));
    }
    
    default <O, T, R, A1, A2, X extends Exception> R apply(Class<O> observer, Function<? super Observable, ? extends Collector<? super T, ?, ? extends R>> collector, F2<O, A1, A2, T, X> signal, A1 arg1, A2 arg2) throws X {
        return apply(observer, collector, o -> signal.apply(o, arg1, arg2));
    }
    
    default <O, T, R, A1, A2, A3, X extends Exception> R apply(Class<O> observer, Function<? super Observable, ? extends Collector<? super T, ?, ? extends R>> collector, F3<O, A1, A2, A3, T, X> signal, A1 arg1, A2 arg2, A3 arg3) throws X {
        return apply(observer, collector, o -> signal.apply(o, arg1, arg2, arg3));
    }
    
    default <O, T, R, A1, A2, A3, A4, X extends Exception> R apply(Class<O> observer, Function<? super Observable, ? extends Collector<? super T, ?, ? extends R>> collector, F4<O, A1, A2, A3, A4, T, X> signal, A1 arg1, A2 arg2, A3 arg3, A4 arg4) throws X {
        return apply(observer, collector, o -> signal.apply(o, arg1, arg2, arg3, arg4));
    }
    
    default <O, T, R, A1, A2, A3, A4, A5, X extends Exception> R apply(Class<O> observer, Function<? super Observable, ? extends Collector<? super T, ?, ? extends R>> collector, F5<O, A1, A2, A3, A4, A5, T, X> signal, A1 arg1, A2 arg2, A3 arg3, A4 arg4, A5 arg5) throws X {
