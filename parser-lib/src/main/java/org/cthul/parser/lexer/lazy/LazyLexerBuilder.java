...
public class LazyLexerBuilder<Token> extends LexerBuilderBase<Token, MatchResult, StringInput> {
    ...
    protected LazyLexerBuilder(LazyLexerBuilder<Token> source) {
        super(source);
    }
    ...
    @Override
    public void addStringToken(RuleKey key, InputEval<? extends Token, ? super MatchResult> eval, String string) {
        addMatcher(new LazyStringTokenMatcher(key, eval, string));
    }

    @Override
    public void addStringToken(RuleKey key, InputEval<? extends Token, ? super MatchResult> eval, String... strings) {
