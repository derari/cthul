...
public class SimpleTokenLexerTest {
    ...
    protected <V, T extends Token<? extends V>> InputEval<T, Object> e(
                    InputEval<T, ? super TokenBuilder<V, ? super T>> eval) {
     ...
     */
    protected class PiEval<T extends Token<?>> implements InputEval<T, TokenBuilder<? super Double, ? extends T>> {
        @Override
    ...
    protected class ParseEval implements InputEval<DoubleToken, TokenBuilder<? super Double, ? super DoubleToken>> {
        @Override
