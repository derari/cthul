...
import org.cthul.parser.lexer.LexerException;
...
public class SimpleLexer<I extends Input<?>> extends LexerBase<I> {
    ...
    public static abstract class State<Token, I extends Input<?>> {
        ...
        protected I scan() {
            ...
            return createInput(tokens);
        }

        protected abstract I createInput(List<Token> tokens);
    ...
    protected static abstract class MatchingRule<Token, Match, S extends State<?,?>> extends Rule<Token, S> {
        ...
        private final MatchEval<? extends Token, ? super Match> eval;

        public MatchingRule(RuleKey key, int id, MatchEval<? extends Token, ? super Match> eval) {
            super(key, id);
            this.eval = eval;
        }
    ...
    protected static abstract class StringRule<Token, Match, S extends State<?,?>> extends MatchingRule<Token, Match, S> {
        ...
        public StringRule(RuleKey key, int id, MatchEval<? extends Token, ? super Match> eval, String[] strings) {
            super(key, id, eval);
    ...
    protected static abstract class RegexRule<Token, Match, S extends State<?,?>> extends MatchingRule<Token, Match, S> {
        ...
        public RegexRule(RuleKey key, int id, MatchEval<? extends Token, ? super Match> eval, Pattern pattern) {
            super(key, id, eval);
